...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    id: "projects",
    title: "プロジェクト",
    text: "Hub が管理するプロジェクトの一覧です。プロジェクトごとに、7つの工程（Phase）の進み具合を小さなバーで、品質検査が停止した回数を「停止 n」で示します。選ぶと、そのプロジェクトの画面を開けます。",
    target: "projects",
    side: "right",
  },
  {
  ...
  },
  {
    id: "timeline",
    title: "履歴と再生",
    text: "これまでの出来事が新しい順に並びます。行を押すと、いつ・誰が・何を根拠にした出来事かを確かめられます。「Hub の統制記録」で絞り込めます。再生バーの赤い印は、品質検査で止まった位置です。",
    target: "timeline",
    side: "left",
  },
];
...
export const HELP: Record<string, { title: string; text: string }> = {
  ...
  timeline: {
    title: "履歴",
    text: "これまでの出来事が新しい順に並びます。行を押すと、いつ・誰が・何を根拠にした出来事かを確かめられます。「Hub の統制記録」で絞り込めます。",
  },
  legend: {
    title: "実測・再構成・架空",
