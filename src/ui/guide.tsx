...
export const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    points: [
      ...
      { label: "構想：必要な検査・承認を確認して進行を許可します", control: true },
  ...
  },
  {
    id: "projects",
    title: "プロジェクト",
    text: "Hub が管理するプロジェクトの一覧です。プロジェクトごとに、7つの工程（Phase）の進み具合を小さなバーで、品質検査の停止・未達の回数を「停止 n」で示します。選ぶと、そのプロジェクトの画面を開けます。",
    target: "projects",
    side: "right",
  },
  {
    ...
    text: "帯の付いたカードは、再生位置の出来事の説明です。帯が赤いときは、検査の停止・未達や再生モデルによる判定がある場面です。元記録の由来と、解釈・構想の説明を分けて表示します。続けて、選んだプロジェクトの工程・要求・作業・検査・承認・監査記録が並びます。",
    target: "now",
    side: "below",
  },
  {
    id: "timeline",
    title: "履歴と再生",
    text: "これまでの出来事が新しい順に並びます。行を押すと、いつ・誰が・何を根拠にした出来事かを確かめられます。「統制に関わる記録」で絞り込めます。再生バーの赤い印は、品質検査で止まった位置です。",
    target: "timeline",
    side: "left",
  },
];
...
export const HELP: Record<string, { title: string; text: string }> = {
  projects: {
    title: "プロジェクト",
    text: "Hub が管理するプロジェクトの一覧です。プロジェクトごとに、7つの工程（Phase）の進み具合と、検査の停止・未達の記録数を示します。",
  },
  now: {
    title: "いま起きたこと",
    text: "再生位置の出来事を平易な言葉で説明します。帯が赤いときは、検査の停止・未達や再生モデルによる判定がある場面です。元記録の由来と、解釈・構想の説明を分けて表示します。",
  },
  screen: {
    title: "プロジェクトの状態",
  ...
  timeline: {
    title: "履歴",
    text: "これまでの出来事が新しい順に並びます。行を押すと、いつ・誰が・何を根拠にした出来事かを確かめられます。「統制に関わる記録」で絞り込めます。",
  },
  legend: {
    title: "実測・再構成・架空",
  ...
  player: {
    title: "再生",
    text: "再生バーで出来事を再生します。1件ずつ進める・戻すもできます（← → キー）。赤い印は品質検査で止まった位置で、「⚑ 次の停止へ」でそこまで一気に進めます。",
  },
};
